...
export class ContainifyCoreModule {
  ...
  constructor(hostInitializer: HostInitializerService, remoteInitializer: RemoteInitializerService) {
    if (ContainifyCoreModule.currentConfig && ContainifyCoreModule.currentConfig.host) {
  ...
  static withConfig(config: ContainifyCoreModuleConfig): ModuleWithProviders<ContainifyCoreModule> {
